...
export default function Contact() {
  return (
    <div>
      <Helmet>
        <title>Contact | Dr. Fernando Aceves</title>
        <meta
          name="description"
          content="Schedule an appointment or video consultation. Contact details, address, and map."
        />
      </Helmet>
      ...
      <BlogHero
        eyebrow="Contact"
        title="Contact"
        subtitle="Schedule an appointment or video consultation."
      />
