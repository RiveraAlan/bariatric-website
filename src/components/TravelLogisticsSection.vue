...
import { Plane, Hotel, Calendar, Shield, Users, Phone } from 'lucide-vue-next'
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-3 gap-8 mb-12">
        <div class="text-center">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-2">Easy Travel</h3>
        ...
        <div class="text-center">
          <div class="bg-primary-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
            <Hotel class="w-8 h-8 text-primary-600" />
          </div>
          <h3 class="text-xl font-bold text-gray-900 mb-2">Comfortable Stay</h3>
          <p class="text-gray-600">
      ...
      <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-8 md:p-12">
        ...
        <div class="space-y-6 max-w-3xl mx-auto">
          <div class="flex gap-4">
            <div class="flex-shrink-0">
              <div class="bg-primary-600 text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">
                1
              </div>
            </div>
            <div class="flex-1">
              <h4 class="font-bold text-gray-900 mb-1">Day 1: Arrival</h4>
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              <h4 class="font-bold text-gray-900 mb-1">Day 2: Surgery Day</h4>
              <p class="text-gray-700">
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              <h4 class="font-bold text-gray-900 mb-1">Day 3: Recovery</h4>
              <p class="text-gray-700">
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              <h4 class="font-bold text-gray-900 mb-1">Day 4: Hotel Recovery</h4>
              <p class="text-gray-700">
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1">
              <h4 class="font-bold text-gray-900 mb-1">Day 5: Return Home</h4>
              <p class="text-gray-700">
      ...
      <div class="mt-12 grid md:grid-cols-3 gap-6">
        <div class="bg-white border-2 border-gray-200 rounded-lg p-6">
          ...
          <h4 class="font-bold text-gray-900 mb-2">Flexible Scheduling</h4>
        ...
        <div class="bg-white border-2 border-gray-200 rounded-lg p-6">
          ...
          <h4 class="font-bold text-gray-900 mb-2">Companion Welcome</h4>
          <p class="text-gray-600 text-sm">
        ...
        <div class="bg-white border-2 border-gray-200 rounded-lg p-6">
          <Phone class="w-8 h-8 text-primary-600 mb-3" />
          <h4 class="font-bold text-gray-900 mb-2">Lifetime Follow-Up</h4>
          <p class="text-gray-600 text-sm">
